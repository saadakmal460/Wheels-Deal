...
import { FaHome, FaPlus, FaList, FaUserEdit, FaUserTimes, FaSignOutAlt, FaUser, FaCrop, FaCross, FaTimes } from 'react-icons/fa'; // Import react-icons

const SideBar = ({ isOpen, toggleSidebar , handleLogOut }) => {
    return (
        <div
            className={`fixed top-0 left-0 bottom-0 z-50 w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto transition-transform duration-300 sidebar ${
