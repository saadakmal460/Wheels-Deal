...
import { FaCar, FaCamera, FaDollarSign, FaUser, FaExclamationCircle, FaCheckCircle, FaSpinner, FaArrowRight, FaArrowLeft } from 'react-icons/fa'
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <select
                                        ...
                                        onBlur={handleBlur}
                                        onChange={handleInputChange}
                                        className={`block w-full px-4 py-2 text-black bg-white rounded-md focus:outline-none focus:ring-1 ${formError.year ? 'focus:ring-red-500' : 'focus:ring-gray-500'}`}
                                        style={{
                            ...
                            <div className="mb-4">
                                ...
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                    <div className="space-y-1 text-center">
                                        ...
                                        <p className="text-xs text-black">PNG, JPG, JPEG up to 2MB</p>
                                        {files && (
                                            <p className="text-xs text-gray-500">{files.length} {files.length === 1 ? 'file' : 'files'} selected</p>
                                        )}
                                    </div>
                                </div>
